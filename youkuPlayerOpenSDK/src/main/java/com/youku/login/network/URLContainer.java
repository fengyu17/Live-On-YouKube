...
public class URLContainer {
    ...
    public static final String OFFICIAL_YOUKU_AUTHORIZE = "https://openapi.youku.com/v2/oauth2/authorize";
    public static final String OFFICIAL_YOUKU_ACCESSTOKEN = "https://openapi.youku.com/v2/oauth2/token";
    ...
    public static String getAuthorizeURL() {
        StringBuilder s = new StringBuilder();
        s.append(OFFICIAL_YOUKU_AUTHORIZE);
        s.append("&client_id=" + "9b0fa02d0a0a1512");
        s.append("&response_type=" + "code");
        s.append("&redirect_uri=" + "http://www.youku.com");
        s.append("&state=" + "");
        return s.toString();
    }
     ...
     * @return
     */
    public static String getAceessTokenURL(int code) {
        StringBuilder s = new StringBuilder();
        s.append(OFFICIAL_YOUKU_ACCESSTOKEN);
        s.append("&client_id=" + "9b0fa02d0a0a1512");
        s.append("&client_secret=" + "f249f6d842f29db01afabb49f7bb7809");
...
/*	*/
     ...
     *
     * @param actionType 1 用户启动应用 2 用户登录 3 用户登出 4 用户切换应用中的推送状态
     * @param status     PUSH状态，action=4时必填。ENABLED 可用，DISABLED 禁用
     * @return
     *//*
