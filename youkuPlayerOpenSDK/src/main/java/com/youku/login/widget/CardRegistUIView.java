...
//			register_name_tip.setText(getContext().getString(R.string.tips_auth_code_not_fit_rule));
	...
	public void AddListener() {
		// 手机号码注册
		layout_phone_number_regist.setOnClickListener(new OnClickListener() {
		...
		// 邮箱地址注册
		layout_email_address_regist.setOnClickListener(new OnClickListener() {
		...
		// 用户发送手机验证码
		user_regist_get_authcode_textview.setOnClickListener(new OnClickListener() {
