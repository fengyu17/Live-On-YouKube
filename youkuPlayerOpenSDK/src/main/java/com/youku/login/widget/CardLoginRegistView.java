...
//		Logger.lxf("====isNormalScale()======"+isShowScanView());
	...
	private void setOnclickEvent(){
		loginUICardView.setOnClickListener(new OnClickListener() {
	...
	private void setRegistOnClickListener(){
		((LinearLayout) reback_login_textview.getParent()).setOnClickListener(new OnClickListener() {
		...
		reback_login_textview.setOnClickListener(new OnClickListener() {
