...
//        			 Wt = dm.heightPixels;
    ...
    private void matchUIAdapter(Rect rect) {
        ...
        if (!IsLandSpace) {
            ...
            LayoutParams paramsFrameLayout = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
            ...
            LayoutParams paramsView = new LayoutParams(tempMarginLeft, LayoutParams.MATCH_PARENT);
